defmodule DailyLogos.Quotes do
  @moduledoc """
  The Quotes context.
  """
  ...
  @doc """
  Gets a single quote by day and month.

  ## Examples

      iex> get_quote_by_day_month(1, 1)
      %Quote{}

      iex> get_quote_by_day_month(32, 13)
      nil

  """
  def get_quote_by_day_month(day, month) do
    Repo.get_by(Quote, day: day, month: month)
  end
