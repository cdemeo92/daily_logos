...
#
#     PHX_SERVER=true bin/daily_logos start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :daily_logos, DailyLogosWeb.Endpoint, server: true
end
...
config :daily_logos,
  feedback_form_url_it: System.get_env("FEEDBACK_FORM_URL_IT"),
  feedback_form_url_en: System.get_env("FEEDBACK_FORM_URL_EN")
...
if config_env() == :dev do
  database_url =
    System.get_env("DATABASE_URL") ||
      "ecto://postgres:postgres@localhost:5433/daily_logos_dev"
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "daily-logos.com"

  config :daily_logos, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :daily_logos, DailyLogos.Mailer,
